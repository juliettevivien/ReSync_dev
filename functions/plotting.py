...
def plot_LFP_artefact_channel(
    ...
    if saving_folder:
        plt.savefig(savingpath + '\\Intracerebral channel raw plot.png',bbox_inches='tight')
...
def plot_BIP_artefact_channel(
    ...
    if saving_folder:
        plt.savefig(savingpath + '\\External bipolar channel raw plot.png',bbox_inches='tight')
